...
namespace IFCS {   
    ...
    {    
        ...
        ImVec4 WHITE();
        ImVec4 BLACK();
        ImVec4 GRAY(int weight = 400, ETheme ActiveTheme = ETheme::Light);
        ImVec4 BLUE(int weight = 400, ETheme ActiveTheme = ETheme::Light);
        ImVec4 RED(int weight = 400, ETheme ActiveTheme = ETheme::Light);
        ImVec4 ORANGE(int weight = 400, ETheme ActiveTheme = ETheme::Light);
        ImVec4 GREEN(int weight = 400, ETheme ActiveTheme = ETheme::Light);
        ImVec4 INDIGO(int weight = 400, ETheme ActiveTheme = ETheme::Light);
        ImVec4 CELERY(int weight = 400, ETheme ActiveTheme = ETheme::Light);
        ImVec4 MAGENTA(int weight = 400, ETheme ActiveTheme = ETheme::Light);
        ImVec4 YELLOW(int weight = 400, ETheme ActiveTheme = ETheme::Light);
        ImVec4 FUCHSIA(int weight = 400, ETheme ActiveTheme = ETheme::Light);
        ImVec4 SEAFOAM(int weight = 400, ETheme ActiveTheme = ETheme::Light);
        ImVec4 CHARTREUSE(int weight = 400, ETheme ActiveTheme = ETheme::Light);
        ImVec4 PURPLE(int weight = 400, ETheme ActiveTheme = ETheme::Light);
        
        // Sets the ImGui style to Spectrum
        void ApplyTheme(ETheme ActiveTheme = ETheme::Light);
