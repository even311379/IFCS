...
// int main()
// {
//     // test and compare play video speed
//
//     cv::VideoCapture cap("FishTest.mp4");
//     if (!cap.isOpened())
//     {
...
//     cv::namedWindow("A_good_name",cv::WINDOW_NORMAL);
//     int Tick = 0;
//     while (1)
//     {
...
//             std::string S = "MS: " + std::to_string(MS);
//             std::cout << MS << std::endl;
//             cv::putText(frame, S, cv::Point(50, 100), cv::FONT_HERSHEY_SIMPLEX, 2, cv::Scalar(255, 0, 0), 2);
//         }
//
...
// {
//
//     cv::VideoCapture capture("FishTest.mp4");
//     if (!capture.isOpened()) {
