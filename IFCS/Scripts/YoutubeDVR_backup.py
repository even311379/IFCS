...
stream = CamGear(source='https://youtu.be/gBl-BaBM3y8',stream_mode = True,logging=True).start() 
...
while True:
    ...
    cv2.putText(frame, "Custom DVR backup by opencv and VidGear", (10, 50), cv2.FONT_HERSHEY_COMPLEX, 1, (0, 255, 255), 1, cv2.LINE_AA)
