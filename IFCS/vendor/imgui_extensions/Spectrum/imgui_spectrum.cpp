...
namespace Spectrum
{
    ...
    ImVec4 GRAY(int weight, bool IsLight)
    {
        if (IsLight)
        {
            switch (weight)
    ...
    ImVec4 BLUE(int weight, bool IsLight)
    {
        if (IsLight)
        {
            switch (weight)
    ...
    ImVec4 RED(int weight, bool IsLight)
    {
        if (IsLight)
        {
            switch (weight)
    ...
    ImVec4 ORANGE(int weight, bool IsLight)
    {
        if (IsLight)
        {
            switch (weight)
    ...
    ImVec4 GREEN(int weight, bool IsLight)
    {
        if (IsLight)
        {
            switch (weight)
    ...
    ImVec4 INDIGO(int weight, bool IsLight)
    {
        if (IsLight)
        {
            switch (weight)
    ...
    ImVec4 CELERY(int weight, bool IsLight)
    {
        if (IsLight)
        {
            switch (weight)
    ...
    ImVec4 MAGENTA(int weight, bool IsLight)
    {
        if (IsLight)
        {
            switch (weight)
    ...
    ImVec4 YELLOW(int weight, bool IsLight)
    {
        if (IsLight)
        {
            switch (weight)
    ...
    ImVec4 FUCHSIA(int weight, bool IsLight)
    {
        if (IsLight)
        {
            switch (weight)
    ...
    ImVec4 CHARTREUSE(int weight, bool IsLight)
    {
        if (IsLight)
        {
            switch (weight)
    ...
    ImVec4 PURPLE(int weight, bool IsLight)
    {
        if (IsLight)
        {
            switch (weight)
    ...
    void StyleColorsSpectrum(bool is_light)
    {
        ...
        colors[ImGuiCol_Text] = GRAY(800, is_light); // text on hovered controls is gray900
        colors[ImGuiCol_TextDisabled] = GRAY(500, is_light);
        colors[ImGuiCol_WindowBg] = GRAY(100, is_light);
        colors[ImGuiCol_ChildBg] = EMPTY();
        colors[ImGuiCol_PopupBg] = GRAY(50, is_light);
        ...
        colors[ImGuiCol_TitleBgCollapsed] = GRAY(400, is_light);
        colors[ImGuiCol_MenuBarBg] = GRAY(100, is_light);
        colors[ImGuiCol_ScrollbarBg] = GRAY(100, is_light); // same as regular background
        colors[ImGuiCol_ScrollbarGrab] = GRAY(is_light);
        colors[ImGuiCol_ScrollbarGrabHovered] = GRAY(600, is_light);
        colors[ImGuiCol_ScrollbarGrabActive] = GRAY(700, is_light);
        colors[ImGuiCol_CheckMark] = BLUE(500, is_light);
        ...
        */
        ...
        colors[ImGuiCol_HeaderActive] = BLUE(600, is_light);
        colors[ImGuiCol_Separator] = GRAY(400, is_light);
        colors[ImGuiCol_SeparatorHovered] = GRAY(600, is_light);
        colors[ImGuiCol_SeparatorActive] = GRAY(700, is_light);
        colors[ImGuiCol_ResizeGrip] = GRAY(400, is_light);
        colors[ImGuiCol_ResizeGripHovered] = GRAY(600, is_light);
        colors[ImGuiCol_ResizeGripActive] = GRAY(700, is_light);
        colors[ImGuiCol_PlotLines] = BLUE(400, is_light);
        colors[ImGuiCol_PlotLinesHovered] = BLUE(600, is_light);
        colors[ImGuiCol_PlotHistogram] = BLUE(400, is_light);
        colors[ImGuiCol_PlotHistogramHovered] = BLUE(600, is_light);
